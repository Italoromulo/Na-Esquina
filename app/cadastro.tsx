...
const styles = StyleSheet.create({
  ...
  passwordContainer: { flexDirection: 'row', backgroundColor: '#1A120D', borderRadius: 12, marginBottom: 13, borderWidth: 1, borderColor: 'rgba(242,228,212,0.07)', alignItems: 'center' },
  inputPassword: { flex: 1, color: '#F2E4D4', padding: 15, fontSize: 16 },
